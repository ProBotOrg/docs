...
> **BAD WORDS**: This option detects messages containing bad words.

> **DUPLICATED TEXT**: This option detects messages containing duplicated text.

> **REPEATED MESSAGES**: This option detects messages that repeat text or lines like "SPAM SPAM SPAM SPAM."

> **DISCORD INVITES**: This option detects messages containing discord invitation links.

> **LINKS**: This option detects messages that contain links.

> **SPAMMED CAPS (70% > CAPS)**: This option detects messages that are written in all caps, like "HELLO THIS IS PROBOT."

> **EMOJI SPAM**: This option detects messages that contain eight or more emojis.

> **MASS MENTION**: This option detects messages that mention a large number of users.
