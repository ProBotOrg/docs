...
> **ПЛОХИЕ СЛОВА**: This option detects messages containing bad words.

> **ДУБЛИРОВАННЫЙ ТЕКСТ**: This option detects messages containing duplicated text.

> **ПОВТОРЯЮЩИЕСЯ СООБЩЕНИЯ**: This option detects messages that repeat text or lines like "SPAM SPAM SPAM SPAM."

> **DISCORD-ПРИГЛАШЕНИЯ**: This option detects messages containing discord invitation links.
