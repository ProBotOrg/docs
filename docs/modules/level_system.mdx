---
sidebar_position: 6
keywords: [Level System, ProBot, levelling system, active server members, level roles, privileged permissions, mystery channels, specific level, dashboard, configurations, server, module, enabled, options, No XP Roles, No XP Channels, Level-Up Message, congratulatory messages, text level, voice level, role reward system, Add Role Rewards, custom level, Text Level, Voice Level, Role Rewards, higher level, stack, DM Member, level requirement, Text only, Voice only, Role Position, XP data, update, voice-level prizes] 
---
