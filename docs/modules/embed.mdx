...
To create a new embed, click the `Create` button. This will redirect you to a new page where you can preview the appearance of the embed message and make any necessary adjustments. This page also contains several buttons, such as `Send to a Channel,` `Edit a Sent Message,` `Save Changes,` and `Cancel Changes`.
