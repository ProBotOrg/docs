---
sidebar_position: 6
keywords: [rich embeds, customized messages, create new embed, preview appearance, send to channel, edit sent message, save changes, cancel changes, configure embed message, add fields, title, description, URL, image, thumbnail, author, color, footer, field, limits, character limits, Discord embed feature, maximum fields, field name, field value, embed footer, embed author name, total characters allowed] 
---
