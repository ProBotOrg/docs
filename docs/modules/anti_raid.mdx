---
sidebar_position: 15
keywords: [Anti-Raid, ProBot, Tier 2, Tier 1, subscribers, configuration, Account Age, List Length, Time To Fill The List, Action To Take, Mute, Ban, Disable Welcome During Raid, Send A Message To A Channel, Discord, server, raiders, unwanted raiders, module, switch button, minimum, detection, join, time frame, mute, ban, duration, welcome message, spam, channel, start, end, keep track, Protection, System, Automatic, Configuration, Options, Four options, None, Detection, Users joining, Action against raiders, Example, ProBot feature, Update, Message, Customize, Happening, Server, Users, Account ages, Time, Seconds, Hours, Days, Months, Top right, Enable, Enabled.] 
---
...
This feature is only available for `Tier 2` subscribers.
...
1. To set up the anti-raid feature, first enable the module through the switch button on the top right.
2. Once the module is enabled, you can now configure the options as desired.
