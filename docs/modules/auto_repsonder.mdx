---
sidebar_position: 5
keywords: [Auto Responder, dashboard, server, module, trigger, wildcard, reply, ping, author, response, variables, random responses, configuration options, Add Response button, configurations, activations, bot's response, complete sentence, single word, Discord reply option, message, automated response, user's name, unique variables, unbounded number, varied response, interesting response, confusion, errors, cautious configuration, alerting] 
---
