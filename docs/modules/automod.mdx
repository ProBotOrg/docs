...
As a side note, we have some actions that are managed by the AutoMod rule in Discord, which will be indicated next to the AutoMod option. ProBot will manage the ones that do not have the discord automod scanning mentioned. 
...
Each detection option offers two different action options to meet the specific needs of your community. These actions are:
