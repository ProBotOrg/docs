...
sidebar_postion: 9
title: Colors
keywords: [Discord, color feature, custom roles, members, appearance, engagement, server, title, icon shape, background image, settings, configuration panel, square, circle, transparent, custom image] 
---
