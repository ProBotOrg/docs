...
keywords: [ProBot, temporary channels, user-controlled channels, dashboard, server, voice channel, category, customization, permissions, channel deletion time, maximum channels per user, maximum users per channel, Move Members permission] 
---
