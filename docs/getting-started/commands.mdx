...
| ------------- |:-------------:|:-------------:|
| c | Show yours or somebody else's credit | c [user] (amount) |
...
| rang | Lists you all the available colors | rang |
...
| Command | Explanation | Usage |
| ------------- |:-------------:|:-------------:|
| p | View your or someone else's customizable personal global profile card | p (user) |
| rank | View your rank card or someone else's in the server | rank (user) |
| t | Display the top members by text or voice | t (day/week/month) |
