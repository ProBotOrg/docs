...
`[inviter]` - This variable mentions the inviter (vip only).

`[server]` - This variable displays the server name.

`[userName]` - This variable displays the name of the newcomer member.

`[inviterName]` - This variable displays the name of the inviter (vip only).
...
`[invites]` - This variable displays the number of invites you have reached (vip only).
