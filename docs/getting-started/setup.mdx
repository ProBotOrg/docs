...
keywords: [ProBot, setup, configuration, discord, server, invite, authorization, permissions, role, hierarchy, dashboard, support]
---
...
Note: Discord may not always display the roles on the dashboard, even after dragging ProBot's role to the top. If this happens, try these steps:
