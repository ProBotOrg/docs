...
keywords: [Auto-role, Anti-raid, Personalized bot, Custom bot username, Avatar, Status, Command, Token, Dashboard, Payment method, Credit cards, PayPal, Credits, Insufficient money, Refund policy, Multiple subscriptions]
---
...
- Executioner in Logs
- Auto-Role for Specific Invite Link
...
The second tier is ideal for larger servers and includes all the features from Tier 1, as well as:
...
- **Tier 1**: You can edit the payment cycle, invite the bot, and renew it using your preferred payment method.

- **Tier 2**: You can edit the bot's presence, username, avatar, and status, and invite the bot and renew it just like with Tier 1. Additionally, you will have a unique bot number that you can use for special needs.

## Payment Cycle and Prices

We offer two payment options: monthly or annually. __Don't forget, the annual plan comes with a 50% discount__!
...
- **__Credit Cards__**: We accept all major credit cards from any country worldwide. The displayed amount may be in dollars, but it will be automatically converted to your currency.
...
To access the premium features, you must invite the bot to your server. The inviting process can be completed through the Manage Premium page, which can be accessed through this [link].
